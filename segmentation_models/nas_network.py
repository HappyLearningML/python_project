...
from frontends.utils import nas_cell
from tf_utils.utils import resize_bilinear
from tf_utils.utils import scale_dimension
...
def pnasnet(images,
  ...
  cell = nas_cell.PNASCell(hparams.num_conv_filters,
...
def hnasnet(images,
  ...
  cell = nas_cell.NASBaseCell(hparams.num_conv_filters,
                     operations,
                     used_hiddenstates,
                     hiddenstate_indices,
                     hparams.drop_path_keep_prob,
